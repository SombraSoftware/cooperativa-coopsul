...
<head>
    ...
    <link rel="canonical" href="https://www.cooperativa-coopsul.site/">
    ...
    <meta property="og:url" content="https://www.cooperativa-coopsul.site/">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "Organization",
        "name": "Cooperativa Coopsul",
        "url": "https://www.cooperativa-coopsul.site/",
        "logo": "https://www.cooperativa-coopsul.site/assets/img/logo_coopsul.png",
        "image": "https://www.cooperativa-coopsul.site/assets/img/og/social_3.png",
        "email": "contato.coopsul@gmail.com",
        "telephone": "+55 68 99257-3482",
        "address": {
            "@type": "PostalAddress",
            "streetAddress": "Rua Paraíba, nº 974, Bairro do Remanso",
            "addressLocality": "Cruzeiro do Sul",
            "addressRegion": "AC",
            "addressCountry": "BR"
        },
        "sameAs": [
            "https://facebook.com/coopsul.ac",
            "https://instagram.com/coopsul.ac"
        ]
    }
    </script>
    ...
    <header>
        <div class="container">
            ...
            <nav aria-label="Navegação principal">
                <ul>
                    <li><a href="index.html" class="active" aria-current="page"><img class="nav-icon" src="./assets/vendor/fontawesome/svgs/regular/house.svg" alt=""><span class="nav-label">Início</span></a></li>
...
<!-- Local para adicionar notícias, posts extraídos do instagram -->
        <section class="benefits">
            <div class="container">
                <h2>Notícias Coopsul</h2>
                <p class="news-intro">Acompanhe as ações, projetos e novidades da nossa cooperativa.</p>
                <div id="noticias-coopsul" class="news-grid" aria-live="polite">
                    <p class="news-status">Carregando notícias...</p>
                </div>
            </div>
        </section>
