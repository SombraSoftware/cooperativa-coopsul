        ...
        <div class="container">
            ...
            <nav aria-label="Navegação principal">
                <ul>
                    ...
                    <li><a href="sobre.html" class="active" aria-current="page"><img class="nav-icon" src="./assets/vendor/fontawesome/svgs/regular/address-card.svg" alt=""><span class="nav-label">Sobre Nós</span></a></li>
            ...
            <div class="container">
                ...
                <div class="values-grid">
                    <div class="value-card">
                        <div class="value-icon"><img class="fa-icon card-icon" src="./assets/vendor/fontawesome/svgs/regular/handshake.svg" alt=""></div>
                        <h3>Cooperativismo</h3>
                        <p>Trabalhamos juntos para o benefício de todos os cooperados, com decisões coletivas e democráticas.</p>
                    </div>
                    <div class="value-card">
                        <div class="value-icon"><img class="fa-icon card-icon" src="./assets/vendor/fontawesome/svgs/regular/map.svg" alt=""></div>
                        <h3>Sustentabilidade</h3>
                        <p>Promovemos a preservação ambiental através da reciclagem e conscientização ecológica.</p>
                    </div>
                    <div class="value-card">
                        <div class="value-icon"><img class="fa-icon card-icon" src="./assets/vendor/fontawesome/svgs/regular/building.svg" alt=""></div>
                        <h3>Geração de Renda</h3>
                        <p>Transformamos materiais recicláveis em fonte de trabalho e renda para nossas famílias.</p>
                    </div>
                    <div class="value-card">
                        <div class="value-icon"><img class="fa-icon card-icon" src="./assets/vendor/fontawesome/svgs/regular/house.svg" alt=""></div>
