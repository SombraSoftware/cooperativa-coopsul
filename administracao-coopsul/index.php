...
<header class="admin-header"><div><strong>Coopsul</strong><span>Painel editorial</span></div><div><?= e(user()['name']) ?> · <?= e(ucfirst(user()['role'])) ?> <a href="logout.php">Sair</a></div></header>
