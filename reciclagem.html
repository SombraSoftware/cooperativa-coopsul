        ...
        <div class="container">
            ...
            <nav aria-label="Navegação principal">
                <ul>
                    ...
                    <li><a href="reciclagem.html" class="active" aria-current="page"><img class="nav-icon" src="./assets/vendor/fontawesome/svgs/regular/trash-can.svg" alt=""><span class="nav-label">Reciclagem</span></a></li>
                    ...
                    <li><a href="contato.html"><img class="nav-icon" src="./assets/vendor/fontawesome/svgs/regular/envelope.svg" alt=""><span class="nav-label">Contato</span></a></li>
                </ul>
            </nav>
        </div>
    </header>
            ...
            <div class="container">
                ...
                <div class="materials-list">
                    <div class="material-category">
                        <div><img class="fa-icon heading-icon-recycle" src="./assets/icones/reciclaveis/papel_2.png" alt="Lixeira com papel e papelão"></div>
                    ...
                    <div class="material-category">
                        <div><img class="fa-icon heading-icon-recycle" src="./assets/icones/reciclaveis/plastico_2.png" alt="Lixeira com plásticos"></div>
                        <h3>Plásticos</h3>
                        <ul>
                            <li>Garrafas PET</li>
                    ...
                    <div class="material-category">
                        <div><img class="fa-icon heading-icon-recycle" src="./assets/icones/reciclaveis/metal_2.png" alt="Lixeira com metais"></div>
                        <h3>Metais</h3>
                        <ul>
                    ...
                    <div class="material-category">
                        <div><img class="fa-icon heading-icon-recycle" src="./assets/icones/reciclaveis/vidro_2.png" alt="Lixeira com vidros"></div>
                        <h3>Vidros</h3>
                        <ul>
        ...
        <section class="delivery-info">
            <div class="container">
                ...
                <div class="delivery-options">
                    <div class="option">
                        <h3><img class="fa-icon heading-icon" src="./assets/vendor/fontawesome/svgs/regular/map.svg" alt="">Posto de Coleta</h3>
                    ...
                    <div class="option">
                        <h3><img class="fa-icon heading-icon" src="./assets/vendor/fontawesome/svgs/regular/truck.svg" alt="">Coleta Domiciliar</h3>
                        <p>Para grandes quantidades (acima de 50kg), agendamos coleta em domicílio. Entre em contato para marcar.</p>
                    </div>
                    <div class="option">
                        <h3><img class="fa-icon heading-icon" src="./assets/vendor/fontawesome/svgs/regular/building.svg" alt="">Pontos de Entrega Voluntária</h3>
